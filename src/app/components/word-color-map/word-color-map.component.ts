...
@Component({
  ...
  templateUrl: './word-color-map.component.html',
  styleUrl: './word-color-map.component.scss'
})
export class WordColorMapComponent {
  word = '';
  ...
  constructor(
    private dialogRef: MatDialogRef<WordColorMapComponent>,
